...
## python venv: /data1/rubinov_lab/brain_genomics/metacell/aux_scripts/venv_maroon
##
## Variables to modify: GROUP, MODEL, PRED_R2, PRED_PV, 0/1-based SNP position

## updated by Nhung (June 2024)  

#module purge 
#ml GCC/8.2.0 OpenMPI/3.1.4 Python/3.7.2
# source ./models_PrediXcan_v8/venv_predixcan/bin/activate
...
# top_dir="/data1/rubinov_lab/brain_genomics/metacell"
top_dir="../../data"

## input genotype dosages 
genotyp="${top_dir}/inputs_${GROUP}/dosage_${MODEL}/c*.dosage.txt"

## samples 
samples="${top_dir}/inputs_${GROUP}/cohort.txt"

## GREx scripts
grex_script="${top_dir}/aux_scripts/MetaXcan/software/Predict.py"
models_path="${top_dir}/aux_files/models_${MODEL}/models_by_tissue"

## output GREx path
outgrex="${top_dir}/inputs_${GROUP}/grex_${MODEL}"
