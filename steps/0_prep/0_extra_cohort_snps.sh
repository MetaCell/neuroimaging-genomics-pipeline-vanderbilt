...
coho="UKB" # UKB/nonBrit

path_top="/data1/rubinov_lab/brain_genomics"
path_jti="${path_top}/metacell/aux_files/snps_keep.txt"
...
path_cohort="${path_top}/metacell/inputs_${coho}/cohort.txt"

path_bgn="${path_top}/metacell/inputs_${coho}/bgen_JTI"
path_vcf="${path_top}/metacell/inputs_${coho}/vcf_JTI"

for CHR in {22..1} 
do 
    if [[ $CHR == 16 || $CHR == 10 || $CHR == 4 || $CHR == 1 ]]; then
        /home/alxbrd/projects/metacell/vanderbilt/brain_genomics_metacell/plink/plink2 \
...
for CHR in {22..1}
do
    /home/alxbrd/projects/metacell/vanderbilt/brain_genomics_metacell/bgenix/bgenix \
