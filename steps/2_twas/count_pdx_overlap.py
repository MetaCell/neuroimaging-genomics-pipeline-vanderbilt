...
sym_path = f'{top_path}/aux_files/models_JTI/syms_by_tissue/jti_ens_to_sym.csv'

# phe_path = f'{top_path}/paper_twas/aux_files/predixvu_phenames.csv'
phe_path = f'{top_path}/aux_files/predixvu_phenames.csv'
...
twa_path = f'{top_path}/outputs_UKB/twas_JTI/summary.csv'

## out paths 
mid_path = f'{top_path}/outputs_UKB/pdx_overlap/{ptype}_mdf.csv'
gxt_path = f'{top_path}/outputs_UKB/pdx_overlap/{ptype}_table_genxtis.csv'
pxv_path = f'{top_path}/outputs_UKB/pdx_overlap/{ptype}_table_phexvol.csv'
