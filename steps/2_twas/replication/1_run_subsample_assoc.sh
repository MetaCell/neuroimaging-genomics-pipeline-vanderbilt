...
source ../../../envs/venv_predixcan/bin/activate
...
twas_script="${top_dir}/aux_scripts/MetaXcan/software/nh_PrediXcanAssociation.py"

## inputs 
grex_path="${top_dir}/inputs_UKB/grex_JTI"
phen_file="${top_dir}/inputs_UKB/phenotypes/vol_mean.csv"
covs_file="${top_dir}/inputs_UKB/covariates.csv"

## output 
outs_dir="${top_dir}/outputs_UKB/replications"
