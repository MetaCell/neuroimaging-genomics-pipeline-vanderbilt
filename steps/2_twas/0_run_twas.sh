...
PHENS=connmean_noGS_mean
######################

# top_dir="/data1/rubinov_lab/brain_genomics"
top_dir="../../data"
twas_script="${top_dir}/aux_scripts/MetaXcan/software/PrediXcanAssociation.py"

## inputs 
grex_path="${top_dir}/inputs_${GROUP}/grex_${MODEL}"
phen_file="${top_dir}/inputs_${GROUP}/phenotypes/${PHENS}.csv"
covs_file="${top_dir}/inputs_${GROUP}/covariates.csv"

## output 
outs_dir="${top_dir}/outputs_${GROUP}/twas_${MODEL}"
