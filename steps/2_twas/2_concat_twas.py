...
itwa_path = f'{main_path}/outputs_{group}/twas_JTI/cross_regs/{phens}'

gene_path = f'{main_path}/aux_files/models_JTI/syms_by_tissue/jti_ens_to_sym.csv'

outs_path = f'{main_path}/outputs_{group}/twas_JTI/summary.csv'
