...
## paths 
main_path = '../../data'
wjti_path = f'{main_path}/aux_files/models_JTI/weights_by_tissue'

twas_path = f'{main_path}/outputs_{group}/twas_JTI/{phens}' 
gwas_path = f'{main_path}/outputs_{group}/gwas/{phens}'

## out paths 
summ_path = f'{main_path}/outputs_{group}/TWAS_GWAS_summary.csv'
sigs_path = f'{main_path}/outputs_{group}/TWAS_GWAS_sigbars.csv'

summ_rtmp = f'{main_path}/outputs_{group}/tgwa' 
sigs_rtmp = f'{main_path}/outputs_{group}/sigs' 
